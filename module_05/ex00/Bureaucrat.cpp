...
/*   Updated: 2023/07/31 22:23:44 by edpaulin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Bureaucrat::Bureaucrat(const Bureaucrat &rhs) {
  std::cout << "📑 Bureaucrat copy constructor called 🛠️" << std::endl;
  *this = rhs;
}
...
const char *Bureaucrat::GradeTooHighException::what(void) const throw() {
  return "📑 Bureaucrat grade is too high ⬆️ ⚠️";
}

const char *Bureaucrat::GradeTooLowException::what(void) const throw() {
  return "📑 Bureaucrat grade is too low ⬇️ ⚠️";
}
